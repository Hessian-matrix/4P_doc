...
| non-ROS相机配置 | 默认`1280x1088@30fps`；支持`25/30/40/50/60fps`；输出画布 `1280x1088`/`640x480`/`720x480`/`1280x720`。 |
...
板端软件 `v1.3.0` 提供配套的出厂系统镜像和烧录工具。镜像只适用于原产品原板，不保证其他目标板的兼容性；镜像获取与烧录步骤见 [系统烧录](../ops/system-flashing.md)。
